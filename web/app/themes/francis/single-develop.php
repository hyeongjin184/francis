...
if (have_posts()):
    while (have_posts()):the_post(); 
        if (has_post_thumbnail()) {
            $developImageUrl = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'large')[0]; 
        } else {
            $developImageUrl = get_stylesheet_directory_uri() . "/image/dummy-image/news_thumb_noimage.jpg";
        }
        ?>
                    ...
                    <div class="single-page">
                        <div class="single-page__body">
                            <div class="single-image-container">
                                <div class="single-image-container__image" style="background-image: url('<?php echo $developImageUrl; ?>')"></div>
                                <div class="single-image-container__title-and-tags">
                                    ...
                                    <ul class="tags-container">
                                        <?php
                                        $developTags = get_the_terms($post->ID, 'develop-tag');
                                        if ($developTags) {
                                            foreach ($developTags as $tag) {
                            ...
                            <div class="content-container">
                                ...
                                <div class="link-to-archive">
                                    <a class="link-to-archive__btn" href="<?= get_post_type_archive_link('develop'); ?>">
                                        <span class="text">개발이야기로</span>
